...
/************************************************************************/
constexpr const char* TEXT_BUTTON_LABEL_CONFIRM = "Confirm";
constexpr const char* TEXT_BUTTON_LABEL_CANCEL  = "Cancel";
...
/************************************************************************/
constexpr const char* TEXT_PROJECT_CREATION_LAYER_TITLE = "Creating Project...";
